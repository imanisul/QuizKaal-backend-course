    ...
    lessons: [
      {
        ...
        quiz: {
          ...
          options: ["Make developers do all the work", "Break down silos between development and operations", "Eliminate the need for testing", "Write more code"],
...
console.log("Successfully generated rich 13-module devops data.");
