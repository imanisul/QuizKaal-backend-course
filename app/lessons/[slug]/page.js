  ...
  return (
    <ProgressGuard lessonSlug={params.slug}>
      <div className="grid grid-cols-1 xl:grid-cols-[240px_minmax(0,1fr)_240px] gap-10 max-w-[1400px] mx-auto px-6 sm:px-8 relative z-[1]">
        ...
        {/* Right Sidebar (TOC) */}
        <aside className="hidden xl:block pt-24 pb-32 sticky top-0 h-screen overflow-y-auto pl-6">
          <h3 className="font-bold text-sm tracking-widest uppercase text-textTertiary mb-4">On This Page</h3>
          <p className="text-sm text-textSecondary italic">Navigation mapping coming soon...</p>
        </aside>
      </div>
    </ProgressGuard>
  );
