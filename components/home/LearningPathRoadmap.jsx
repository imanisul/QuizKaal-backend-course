...
export default function LearningPathRoadmap() {
  ...
  return (
    <div ref={containerRef} className="relative max-w-4xl mx-auto py-20 px-6">
      ...
      <div className="absolute left-[40px] top-20 bottom-20 w-[2px] bg-white/[0.05] -translate-x-1/2 rounded-full overflow-hidden">
        {/* Animated Fill Line */}
        <motion.div 
      ...
      <div className="flex flex-col gap-12 md:gap-24">
        {MILESTONES.map((item, idx) => {
          ...
          return (
            <div key={item.id} className="relative flex flex-col md:flex-row items-center gap-8 md:gap-16 w-full">
              
              {/* Center Node / Icon */}
              <div className="absolute left-[40px] -translate-x-1/2 flex items-center justify-center z-10">
                <motion.div 
              ...
              {/* Content Card */}
              <motion.div 
                className="w-full pl-[80px] flex justify-start"
              ...
              >
                <Link href={item.link} className="block w-full group">
                  <div className="p-6 rounded-3xl bg-bgCard border border-white/5 hover:border-primary/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(45,212,191,0.1)] hover:-translate-y-1 relative overflow-hidden">
                    ...
                    <div className="mt-4 flex items-center gap-2 text-sm font-bold text-primary transition-all duration-300">
